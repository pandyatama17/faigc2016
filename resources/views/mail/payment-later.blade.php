<div class="mail-wrapper"  style="color:#092567; line-spacing:0px; font-size:14pt;">
   ...
   <div class="mail-wrapper"  style="color:#092567; line-spacing:0px; font-size:14pt;">
      <p>
         ...
         <br><br>
         Your registration identification is : <span style="color:black;text-decoration:underline; -moz-text-decoration-color: #092567; text-decoration-color: #092567;"><b></b></span>. 
         <br><br>
      ...
      {{-- <address>
        ...
        Meisyani Paramitha Utami<br>
        <abbr title="Phone">P:</abbr> (123) 456-7890
      </address> --}}
      {{-- <address style="font-family:'Times New Roman'; color:#000">
         Meisyani Paramitha Utami<br>
         Email:<a href="mailto:meisyaniparamitha@yahoo.com">meisyaniparamitha@yahoo.com</a>
      </address> --}}
   </div>
</div>
