   ...
   <div class="row">
      ...
      <div class="col-md-5 col-md-offset-1">
         <div class="panel panel-ticket">
            ...
            <div class="panel-body">
               <i>Early registration fee (before July 1<sup>st</sup>)</i>
               <br>
               <b>IDR 5.000.000,-</b>
               <br>
               <i>Regular registration fee (starting July 1<sup>st</sup>)</i>
               <br>
               <b>IDR 6.000.000,-</b>
            </div>
      ...
      {{-- <div class="col-md-4">
         <div class="panel panel-ticket">
            ...
            <div class="panel-body">
               <i>Early registration fee (before July 2nd)</i>
               <br>
               <b>$ 300</b>
               <br>
      ...
      <p class="lead">
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <ol type="a">
                           ...
                           <li>3 dinners and a reception including drinks (non alcohol)</li>
                        </ol>
                     </td>
                     <td>
                        <br>
         ...
         <div class="col-md-12">
            ...
            <ul style="font-size:12pt">
               <li>Cancellation of an accepted application needs to be done in writing to Congress by secretariat@faigc2016bali.com</li>
               <li>In case of cancellation before or on June 23<sup>th</sup>, 2016, 100% of the
               ...
               <li>If cancellation is received after August 23<sup>th</sup> 2016, or if the applicant fails to attend the conference for any reason, there will be no refund.</li>
            </ul> 
         </div>
      </p>
   </div>
